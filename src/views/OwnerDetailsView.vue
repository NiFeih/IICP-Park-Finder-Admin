...
async function fetchFines() {
  ...
  fines.value = finesQuerySnapshot.docs.map(doc => doc.data())
}
...
>
  ...
  <div class="overflow-y-auto h-[350px]"> <!-- Set a fixed height for scrolling -->
    <table class="table-auto w-full bg-white shadow-md rounded-lg px-4">
      ...
      <tbody class="text-center" v-else>
        <tr>
          <td colspan="6">No fines record</td>
        </tr>
      </tbody>
    </table>
  </div>
